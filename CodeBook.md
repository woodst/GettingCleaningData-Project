...
# Summary #
In creating the second tidy dataset for this assignment, ALL of the variable names have had parenthesis and commas stripped, if they had them in the first place.  This means many of the columns have been renamed.  The existing column for subjects has been renamed to "subject", and the numeric activity coding has been replaced with descriptive activities and the column named "activity".  For each variable the mean has been calculated from the subset of each subject for each activity.  The numeric data in each of the 561 numeric columns is one of these averages.  The use of all 561 variables is predicated on the wording of our assignment, which asked for "the average of each variables for each activity for each subject".  There seemed to be a consensus developing in the forums that only the 66 variables from the first tidy data set needed to be used, but that seems like a leap, given the way part 5 was worded.

The 561 variables have been slightly renamed to avoid incompatibility with some of the functions and libraries.  Specifically, each name was stripped of any parentheses and commas, and everything else was left.  For this data set, there are 180 rows (30 subjects X 6 activities each) and 561 variables, each of which is a numeric data type that holds an average score summarized from a large dataset for each subject and each activity.

The larger data set from which this summary is derived is itself a consolidation of the training and test datasets that were included with the original Samsung data.  These two datasets were merged as follows:

<code>
> UCI HAR Dataset/test/subject_test.txt + UCI HAR Dataset/train/subject_train.txt -> UCIMerged/subject.txt

> UCI HAR Dataset/test/y_test.txt + UCI HAR Dataset/train/y_train.txt -> UCIMerged/y.txt

> UCI HAR Dataset/test/X_test.txt + UCI HAR Dataset/train/X_train.txt -> UCIMerged/X.txt

> UCI HAR Dataset/test/Inertial Signals/body_acc_x_test.txt + UCI HAR Dataset/train/Inertial Signals/body_acc_x_train.txt -> UCIMerged/Inertial Signals/body_acc_x.txt

> UCI HAR Dataset/test/Inertial Signals/body_acc_y_test.txt + UCI HAR Dataset/train/Inertial Signals/body_acc_y_train.txt -> UCIMerged/Inertial Signals/body_acc_y.txt

> UCI HAR Dataset/test/Inertial Signals/body_acc_z_test.txt + UCI HAR Dataset/train/Inertial Signals/body_acc_z_train.txt -> UCIMerged/Inertial Signals/body_acc_z.txt
    
> UCI HAR Dataset/test/Inertial Signals/body_gyro_x_test.txt + UCI HAR Dataset/train/Inertial Signals/body_gyro_x_train.txt -> UCIMerged/Inertial Signals/body_gyro_x.txt

> UCI HAR Dataset/test/Inertial Signals/body_gyro_y_test.txt + UCI HAR Dataset/train/Inertial Signals/body_gyro_y_train.txt -> UCIMerged/Inertial Signals/body_gyro_y.txt

> UCI HAR Dataset/test/Inertial Signals/body_gyro_z_test.txt + UCI HAR Dataset/train/Inertial Signals/body_gyro_z_train.txt -> UCIMerged/Inertial Signals/body_gyro_z.txt

> UCI HAR Dataset/test/Inertial Signals/total_acc_x_test.txt + UCI HAR Dataset/train/Inertial Signals/total_acc_x_train.txt -> UCIMerged/Inertial Signals/total_acc_x.txt
 
> UCI HAR Dataset/test/Inertial Signals/total_acc_y_test.txt + UCI HAR Dataset/train/Inertial Signals/total_acc_y_train.txt -> UCIMerged/Inertial Signals/total_acc_y.txt

> UCI HAR Dataset/test/Inertial Signals/total_acc_z_test.txt + UCI HAR Dataset/train/Inertial Signals/total_acc_z_train.txt -> UCIMerged/Inertial Signals/total_acc_z.txt
...
<pre>
  ...
  41  	tBodyAcc.correlation.XZ	    Numeric	    -0.640801596	0.317017635
  ...
  105   tBodyAccJerk.entropy.X	    Numeric	    -0.802168224	0.752455231
  ...
  169   tBodyGyroJerk.mad.X	        Numeric	    -0.994887087	0.04687384
  ...
  233   tBodyAccJerkMag.min	        Numeric	    -0.985908832	-0.235644582
  ...
  297   fBodyAcc.meanFreq.Y	              Numeric -0.269296887	0.310471301
  ...
  361   fBodyAccJerk.min.Z        	      Numeric -0.989029865	-0.558597061
  ...
  425   fBodyAccJerk.bandsEnergy.2548.2	  Numeric	-0.999836611	-0.652877072
  ...
  489   fBodyGyro.bandsEnergy.124.1	      Numeric	-0.999826318	-0.289366111
  ...
  553   fBodyBodyGyroJerkMag.maxInds	    Numeric	-0.97997558	  -0.779178338
